...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.white, paddingHorizontal: 20, paddingTop: 16, paddingBottom: 0, borderBottomWidth: 1, borderBottomColor: Colors.slate100 },
  headerTitle: { fontSize: 24, fontFamily: Fonts.heading, color: Colors.slate900, marginBottom: 14 },
