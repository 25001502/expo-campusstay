...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.navy, paddingHorizontal: 24, paddingBottom: 28, alignItems: 'center' },
  avatar: { width: 72, height: 72, borderRadius: 18, backgroundColor: Colors.blue, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  avatarText: { color: Colors.white, fontSize: 26, fontFamily: Fonts.heading },
  name: { color: Colors.white, fontSize: 22, fontFamily: Fonts.heading, marginBottom: 4 },
  uni: { color: Colors.slate300, fontSize: 14, fontFamily: Fonts.body, marginBottom: 2 },
  studentNo: { color: Colors.slate400, fontSize: 12, fontFamily: Fonts.body, marginBottom: 20 },
  statsRow: { flexDirection: 'row', gap: 0 },
  statItem: { flex: 1, alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.1)', paddingVertical: 12, borderRadius: 0 },
  statVal: { color: Colors.white, fontSize: 20, fontFamily: Fonts.heading },
  statLabel: { color: Colors.slate400, fontSize: 11, fontFamily: Fonts.body, marginTop: 2 },
  menuSection: { padding: 16, gap: 8 },
  menuItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: Radius.xl, paddingHorizontal: 16, paddingVertical: 14, borderWidth: 1, borderColor: Colors.slate100, ...Shadow.sm, gap: 12 },
  menuIcon: { width: 40, height: 40, borderRadius: Radius.md, alignItems: 'center', justifyContent: 'center' },
  menuIconText: { fontSize: 18 },
  menuLabel: { flex: 1, fontSize: 15, fontFamily: Fonts.bodyMed, color: Colors.slate800 },
  menuChevron: { fontSize: 20, color: Colors.slate300 },
  logoutItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF1F2', borderRadius: Radius.xl, paddingHorizontal: 16, paddingVertical: 14, borderWidth: 1, borderColor: Colors.red100, marginTop: 4, gap: 12 },
  logoutLabel: { flex: 1, fontSize: 15, fontFamily: Fonts.bodyMed, color: Colors.red600 },
});
