...
const styles = StyleSheet.create({
  ...
  brand: { color: Colors.white, fontSize: 20, fontFamily: Fonts.heading, marginBottom: 12 },
  title: { color: Colors.white, fontSize: 28, fontFamily: Fonts.heading, marginBottom: 4 },
  ...
  googleText: { fontSize: 14, fontFamily: Fonts.bodyMed, color: Colors.slate700 },
  registerRow: { flexDirection: 'row', justifyContent: 'center', marginBottom: 16 },
  registerText: { fontSize: 14, color: Colors.slate500 },
  registerLink: { fontSize: 14, fontFamily: Fonts.bodySemi, color: Colors.blue },
  managerBtn: { alignItems: 'center' },
  managerText: { fontSize: 13, fontFamily: Fonts.bodyMed, color: Colors.purple },
});
