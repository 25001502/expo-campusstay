...
const styles = StyleSheet.create({
  ...
  searchRow: { flexDirection: 'row', gap: 10, padding: 16, backgroundColor: Colors.white, borderBottomWidth: 1, borderBottomColor: Colors.slate100 },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.slate100, borderRadius: Radius.lg, paddingHorizontal: 12, gap: 8 },
  searchIcon: { fontSize: 15 },
  searchInput: { flex: 1, height: 44, fontSize: 14, fontFamily: Fonts.body, color: Colors.slate800 },
  filterBtn: { width: 44, height: 44, borderRadius: Radius.lg, borderWidth: 1, borderColor: Colors.slate200, backgroundColor: Colors.white, alignItems: 'center', justifyContent: 'center' },
  filterBtnActive: { backgroundColor: Colors.blue, borderColor: Colors.blue },
  filterBtnText: { fontSize: 18 },
  filterPanel: { backgroundColor: Colors.white, borderBottomWidth: 1, borderBottomColor: Colors.slate100, padding: 16, gap: 10 },
  filterLabel: { fontSize: 13, fontFamily: Fonts.bodySemi, color: Colors.slate700 },
  priceRow: { flexDirection: 'row', justifyContent: 'space-between' },
  priceHint: { fontSize: 11, color: Colors.slate400 },
  amenityRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  amenityChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: Radius.full, borderWidth: 1, borderColor: Colors.slate200, backgroundColor: Colors.white },
  amenityChipActive: { backgroundColor: Colors.blue, borderColor: Colors.blue },
  amenityText: { fontSize: 12, fontFamily: Fonts.bodyMed, color: Colors.slate600 },
  amenityTextActive: { color: Colors.white },
  filterActions: { flexDirection: 'row', gap: 10 },
  filterActionBtn: { flex: 1, paddingVertical: 10 },
  sortRow: { paddingHorizontal: 16, paddingVertical: 10, backgroundColor: Colors.white, borderBottomWidth: 1, borderBottomColor: Colors.slate100, gap: 8, alignItems: 'center' },
  sortLabel: { fontSize: 12, color: Colors.slate400, fontFamily: Fonts.body },
  sortChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: Radius.full, backgroundColor: Colors.slate100 },
  sortChipActive: { backgroundColor: Colors.slate900 },
  sortChipText: { fontSize: 12, fontFamily: Fonts.bodyMed, color: Colors.slate600 },
  sortChipTextActive: { color: Colors.white },
  resultsCount: { fontSize: 12, color: Colors.slate400, fontFamily: Fonts.body, marginBottom: 8 },
  card: { backgroundColor: Colors.white, borderRadius: Radius.xl, overflow: 'hidden', ...Shadow.sm },
  cardImageWrapper: { height: 180, position: 'relative' },
  cardImage: { width: '100%', height: '100%' },
  cardBadges: { position: 'absolute', top: 10, left: 10, flexDirection: 'row', gap: 6 },
  favBtn: { position: 'absolute', top: 10, right: 10, width: 32, height: 32, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.85)', alignItems: 'center', justifyContent: 'center' },
  favBtnActive: { backgroundColor: Colors.red500 },
  cardBody: { padding: 16, gap: 6 },
  cardTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  cardName: { fontSize: 16, fontFamily: Fonts.heading, color: Colors.slate900, flex: 1, marginRight: 8 },
  cardLocation: { fontSize: 13, fontFamily: Fonts.body, color: Colors.slate500 },
  tagsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 4 },
  cardPrice: { fontSize: 18, fontFamily: Fonts.heading, color: Colors.slate900 },
  cardPriceSub: { fontSize: 13, fontFamily: Fonts.body, color: Colors.slate400 },
