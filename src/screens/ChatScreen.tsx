...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, backgroundColor: Colors.white, borderBottomWidth: 1, borderBottomColor: Colors.slate100 },
  backText: { fontSize: 22, color: Colors.slate600, width: 24 },
  topInfo: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 },
  topAvatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: Colors.blue, alignItems: 'center', justifyContent: 'center' },
  topAvatarText: { color: Colors.white, fontSize: 13, fontFamily: Fonts.bodySemi },
  topName: { fontSize: 15, fontFamily: Fonts.heading, color: Colors.slate900 },
  onlineRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 1 },
  onlineDot: { width: 7, height: 7, borderRadius: 3.5, backgroundColor: Colors.green600 },
  onlineText: { fontSize: 11, fontFamily: Fonts.body, color: Colors.green600 },
  propLabel: { alignSelf: 'center', backgroundColor: Colors.slate100, paddingHorizontal: 12, paddingVertical: 5, borderRadius: Radius.full, marginVertical: 10 },
  propLabelText: { fontSize: 12, fontFamily: Fonts.body, color: Colors.slate500 },
  ...
  bubbleAvatar: { width: 28, height: 28, borderRadius: 14, backgroundColor: Colors.blue, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  bubbleAvatarText: { color: Colors.white, fontSize: 10, fontFamily: Fonts.bodySemi },
  ...
  bubbleThem: { backgroundColor: Colors.white, borderBottomLeftRadius: 4, borderWidth: 1, borderColor: Colors.slate100 },
  bubbleText: { fontSize: 14, fontFamily: Fonts.body, color: Colors.slate800, lineHeight: 20 },
  bubbleTextMe: { color: Colors.white },
  bubbleTime: { fontSize: 10, fontFamily: Fonts.body, color: Colors.slate400 },
  bubbleTimeMe: { color: 'rgba(255,255,255,0.65)' },
  inputBar: { flexDirection: 'row', alignItems: 'flex-end', gap: 10, paddingHorizontal: 16, paddingTop: 10, backgroundColor: Colors.white, borderTopWidth: 1, borderTopColor: Colors.slate100 },
  input: { flex: 1, backgroundColor: Colors.slate100, borderRadius: Radius.lg, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, fontFamily: Fonts.body, color: Colors.slate800, maxHeight: 100 },
