...
const styles = StyleSheet.create({
  ...
  propertyCard: { flexDirection: 'row', gap: 12, backgroundColor: Colors.white, borderRadius: Radius.xl, padding: 14, ...Shadow.sm },
  propertyImage: { width: 64, height: 64, borderRadius: Radius.lg, backgroundColor: Colors.slate200 },
  propertyInfo: { flex: 1, gap: 4 },
  propertyName: { fontSize: 15, fontFamily: Fonts.heading, color: Colors.slate900 },
  propertyCity: { fontSize: 13, fontFamily: Fonts.body, color: Colors.slate500 },
  appId: { fontSize: 12, fontFamily: Fonts.body, color: Colors.slate400 },
  appIdVal: { fontFamily: Fonts.bodySemi, color: Colors.slate700 },
  timelineCard: { backgroundColor: Colors.white, borderRadius: Radius.xl, padding: 20, ...Shadow.sm, gap: 0 },
  sectionTitle: { fontSize: 17, fontFamily: Fonts.heading, color: Colors.slate900, marginBottom: 16 },
  milestoneRow: { flexDirection: 'row', gap: 14 },
  milestoneLeft: { alignItems: 'center' },
  milestoneCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: Colors.slate200, alignItems: 'center', justifyContent: 'center' },
  milestoneDone: { backgroundColor: Colors.blue },
  milestoneActive: { backgroundColor: Colors.amber },
  milestoneCheck: { color: Colors.white, fontSize: 13, fontFamily: Fonts.bodySemi },
  milestoneDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: Colors.slate400 },
  milestoneDotActive: { backgroundColor: Colors.white },
  milestoneLine: { width: 2, flex: 1, backgroundColor: Colors.slate200, marginVertical: 4, minHeight: 28 },
  milestoneLineDone: { backgroundColor: '#BFDBFE' },
  milestoneContent: { flex: 1, paddingBottom: 24 },
  milestoneLabel: { fontSize: 14, fontFamily: Fonts.bodyMed, color: Colors.slate400 },
  milestoneLabelDone: { color: Colors.slate900 },
  milestoneLabelActive: { color: Colors.amber600, fontFamily: Fonts.bodySemi },
  milestoneSub: { fontSize: 12, fontFamily: Fonts.body, color: Colors.slate400, marginTop: 2 },
