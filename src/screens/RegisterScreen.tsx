...
const styles = StyleSheet.create({
  ...
  infoSub: { color: Colors.blueLight, fontSize: 12, fontFamily: Fonts.body, marginTop: 4 },
  ...
  terms: { fontSize: 12, color: Colors.slate500, lineHeight: 18, marginBottom: 20, fontFamily: Fonts.body },
