...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.white, paddingHorizontal: 20, paddingVertical: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: Colors.slate100 },
  headerTitle: { fontSize: 24, fontFamily: Fonts.heading, color: Colors.slate900 },
  compareBtn: { paddingVertical: 8, paddingHorizontal: 16 },
  hint: { fontSize: 12, fontFamily: Fonts.body, color: Colors.slate400, paddingHorizontal: 20, paddingTop: 10 },
  list: { padding: 16, gap: 14, paddingBottom: 100 },
  empty: { alignItems: 'center', paddingTop: 80, gap: 12 },
  emptyIcon: { fontSize: 56 },
  emptyTitle: { fontSize: 18, fontFamily: Fonts.heading, color: Colors.slate700 },
  emptySub: { fontSize: 13, fontFamily: Fonts.body, color: Colors.slate400 },
  exploreBtn: { marginTop: 8, paddingHorizontal: 24 },
  card: { backgroundColor: Colors.white, borderRadius: Radius.xl, overflow: 'hidden', ...Shadow.sm, borderWidth: 2, borderColor: 'transparent' },
  cardSelected: { borderColor: Colors.blue },
  cardImageWrapper: { height: 160, position: 'relative' },
  cardImage: { width: '100%', height: '100%' },
  checkOverlay: { position: 'absolute', top: 10, left: 10, width: 28, height: 28, borderRadius: 14, backgroundColor: Colors.blue, alignItems: 'center', justifyContent: 'center' },
  checkText: { color: Colors.white, fontSize: 14, fontFamily: Fonts.bodySemi },
  removeBtn: { position: 'absolute', top: 10, right: 10, width: 32, height: 32, borderRadius: 16, backgroundColor: Colors.red500, alignItems: 'center', justifyContent: 'center' },
  ...
  cardPriceSub: { fontSize: 12, color: Colors.slate400, fontFamily: Fonts.body },
